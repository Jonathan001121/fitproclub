/*
Gener: https://github.com/pmndrs/gltfjsx
now use: https://gltf.pmnd.rs/ 
*/
...
export function Avatar(props) {
  ...
  const {actions} = useAnimations(squatAnimation,group );
    useEffect(() =>{
    actions["Squating"].reset().play() ;
...
// useGLTF.preload('models/testing.glb')
